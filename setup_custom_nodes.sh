...
# Runtime-only packs (clone + pip in start.sh — smaller Docker export):
#   crystian/ComfyUI-Crystools, PozzettiAndrea/ComfyUI-DepthAnythingV3,
#   yolain/ComfyUI-Easy-Use, WASasquatch/was-node-suite-comfyui,
