...
export default function AdminAffiliateLanderPreviewFrame() {
  ...
  return (
    <>
      {(spatialCss || styleCss) && <style dangerouslySetInnerHTML={{ __html: `${spatialCss}\n${styleCss}` }} />}
      <AffiliateLanderCanvas config={payload.config} editMode={Boolean(payload.editMode)} />
    </>
  );
}
