 ...
 *
 * Body: {
 *   inputUrl: string,                                      // publicly accessible video URL
 *   timestamps: number[],                                  // seconds at which to extract each frame
 *   outputPutUrls: [{ putUrl: string, publicUrl: string }] // one presigned PUT per timestamp
 * }
